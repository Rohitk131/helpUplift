...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-green-500 rounded-b-2xl">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <Link to='/'><img className='h-10 pr-10' src={Logo} alt='HelpUplift'/></Link>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-white' : 'text-white hover:bg-green-700 hover:text-white transition-all',
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="relative rounded-full bg-green-200 p-1 text-blue-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? ' bg-green-300 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
